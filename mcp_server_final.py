...
# === MCP 伺服器設定 ===
app = Server("taiwan-law-server")

# 工具功能介紹
TOOLS_INTRODUCTION = """
台灣法規查詢系統已載入

我現在可以為您提供完整的台灣法律查詢服務：
...
您可以直接詢問任何台灣法律相關問題，例如：
• "請查詢民法第1條"  
• "搜尋包含'契約'的法條"
• "取得財政收支劃分法的完整內容"

我會自動選擇最適合的工具為您查詢法律條文！
"""
...
async def list_tools() -> Sequence[Tool]:
    ...
    return [
        ...
        Tool(
            name="introduce_law_tools",
            description="介紹台灣法規查詢系統的功能和使用方式，讓用戶了解可用的法律查詢服務",
            inputSchema={
                "type": "object",
                "properties": {},
                "required": []
...
async def call_tool(name: str, arguments: dict) -> Sequence[TextContent]:
    ...
    try:
        ...
        elif name == "introduce_law_tools":
            return [TextContent(type="text", text=TOOLS_INTRODUCTION)]
